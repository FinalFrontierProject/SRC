...
static const uint256 hashGenesisBlock("0x04f146f18e8732397b402d39cec1eb28246e9a40b7cce50e88b4c9a4a665da48");
...
public:
    ...
    {
        // finalfrontier: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // finalfrontier: get transaction coin age
...
public:
    ...
    // finalfrontier: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // finalfrontier: two types of block: proof-of-work or proof-of-stake
    ...
    // finalfrontier: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // finalfrontier: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // finalfrontier: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // finalfrontier: block index flags
    enum
    {
