...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("FinalFrontier-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("FinalFrontier-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("FinalFrontier-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FinalFrontier " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"108.61.211.151", "108.61.211.151"},
    {"104.207.152.137", "104.207.152.137"},
    {"45.76.36.229", "45.76.36.229"},
    {"104.238.184.65", "104.238.184.65"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("FinalFrontier-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("FinalFrontier-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("FinalFrontier-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("FinalFrontier-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FinalFrontier is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("FinalFrontier-start");
