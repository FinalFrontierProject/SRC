...
// finalfrontier: total coins staked (non-spendable until maturity)
...
// FinalFrontier: get current stake weight
...
// finalfrontier: check 'spent' consistency between wallet and txindex
// finalfrontier: fix wallet spent state according to txindex
...
// finalfrontier: disable transaction (only for coinstake)
